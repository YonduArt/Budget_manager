...
public class AddTransactionFragment extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Обработчик входящих транзакций
        binding.incomeBtn.setOnClickListener(view -> {
            ...
            binding.category.setOnClickListener(c-> {
                ...
                CategoryAdapter categoryAdapter = new CategoryAdapter(getContext(), Constants.categoriesIncome, new CategoryAdapter.CategoryClickListener() {
                    @Override
            ...
            binding.account.setOnClickListener(c-> {
                ...
                accounts.add(new Account(0, "Наличка"));
                accounts.add(new Account(0, "Карта"));
        ...
        // Обработчик выходящих транзакций
        binding.expenseBtn.setOnClickListener(view -> {
            ...
            binding.category.setOnClickListener(c-> {
                ...
                CategoryAdapter categoryAdapter = new CategoryAdapter(getContext(), Constants.categoriesExpense, new CategoryAdapter.CategoryClickListener() {
                    @Override
                    public void onCategoryClicked(Category category) {
                        binding.category.setText(category.getCategoryName());
                        transaction.setCategory(category.getCategoryName());
